...
total_times = 0
print("           │¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯│")
print("———————————│ Welcome to Staff Version-Horizontal Histrogram │———————————")
print("           │________________________________________________│")
print("             _______________│______________│_______________ ")
print("            │Credits are in the range 0,20,40,60,80,100,120│")
print("             ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯")

def start_horizantal_histogram():# start in Staff Version-Horizontal Histogram 
    while True:
        print("\n\t◊ Type 'S' to Start Checking Students Results.\n\t◊ Type 'Q' to Check Horizontal Histogram and Quit the Program. ")
        enter_input = str(input("Enter your Decision('S'/'Q') : ")) # user input
        if enter_input == 'S' or enter_input == 's':
            ...
            final_result_horizantal_histogram() # call the function for the shows horizantal histrogram
            break
        else:
            print("\n\t**** Invalid Input! ****")
            continue
...
def final_result_horizantal_histogram():# display Horizontal Histogram
    print()
    print("                        │¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯│")
    print("————————————————————————│ Horizantal Histogram │————————————————————————")
    print("                        │______________________│\n")
    print("Progress\t",progress_times,":",progress_times*"*")
    print("Trailing\t",trailer_times,":",trailer_times*"*")
    print("Retriever\t",retriever_times,":",retriever_times*"*")
    print("Exclude\t\t",exclude_times,":",exclude_times*"*")
    print()
    print(total_times,"Outcome in Total.\n")


start_horizantal_histogram()# Call the start_horizantal_histogram function to start the program
